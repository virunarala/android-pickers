...
class PickImage: ActivityResultContract<PickImageInput, Uri?>() {

    private lateinit var onSuccess: (PickImageOutput) -> Unit
    private lateinit var onFailure: (message: String) -> Unit

    override fun createIntent(context: Context, input: PickImageInput): Intent {
